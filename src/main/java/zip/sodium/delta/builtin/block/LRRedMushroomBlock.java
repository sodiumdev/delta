...
import zip.sodium.delta.api.block.LRTexturedDeltaBlock;

public class LRRedMushroomBlock extends LRTexturedDeltaBlock {
    ...
    public LRRedMushroomBlock(Properties settings) {
